module.exports = class HTTPError extends Error {
  ...
  static INVALID_BODY(msg = 'Invalid body') {
    return new HTTPError(msg, HTTPError.INVALID_BODY)
  }
  ...
  static BODY_TOO_LARGE(msg = 'Body is too large') {
    return new HTTPError(msg, HTTPError.BODY_TOO_LARGE)
  }
  ...
  static UNEXPECTED_REQUEST(msg = 'Request received in place of a response') {
    return new HTTPError(msg, HTTPError.UNEXPECTED_REQUEST)
  }
