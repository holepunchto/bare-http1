...
function HTTPOutgoingMessage(Stream) {
  return class HTTPOutgoingMessage extends Stream {
    constructor(socket = null) {
      ...
      // Whether the framing has been decided. It is decided once, by whichever
      // of the paths below gets there first, and the headers never go out
      // before it has been; a body with no framing at all runs into whatever
