...
module.exports = class HTTPConnection {
  ...
  // Whether the connection has stopped reading for good. A subclass may have
  // more reasons to stop than being detached.
  get _stopped() {
  ...
  _detach() {
    ...
    // Whoever takes the socket over may not be ready for it in this tick, and
    // a socket left flowing with nobody listening reads its data and drops it.
    this._socket.pause()
