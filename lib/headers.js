...
// The one value a field carries, for a field that may only ever carry one. A
// list of exactly one names the same value however it was spelled, and anything
// longer describes a header sent more than once, which for `Content-Length` is
// what a peer reading a different message out of the same bytes depends on.
exports.single = function (value) {
