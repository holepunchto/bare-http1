...
exports.validateHeaderNameType = function (name) {
...
exports.validateStatusMessage = function (value) {
  ...
  if (VALUE_INVALID_RE.test(message)) {
...
exports.validateHost = function (value) {
  if (typeof value !== 'string') {
    throw errors.INVALID_HEADER_VALUE(`Invalid host: ${JSON.stringify(value)}`)
  }
}
